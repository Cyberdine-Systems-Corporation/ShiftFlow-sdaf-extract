...
{
    /// <summary>
    /// Baseline del esquema ShiftFlow (Identity + agregados de dominio) — ADR-007.
    /// </summary>
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    MinimumRestMinutes = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leaves_OrganizationId_StartOn",
                table: "Leaves",
                columns: new[] { "OrganizationId", "StartOn" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_OrganizationId",
                table: "ShiftAssignments",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_OrganizationId_StartAt",
                table: "ShiftAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftTypes_OrganizationId_Code",
                table: "ShiftTypes",
                columns: new[] { "OrganizationId", "Code" });

            migrationBuilder.CreateIndex(
                name: "IX_ShiftTypes_OrganizationId_Name",
                table: "ShiftTypes",
                columns: new[] { "OrganizationId", "Name" });
        }
