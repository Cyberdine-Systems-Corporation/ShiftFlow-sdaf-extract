...
3. Estado **Draft**; versionar patch/minor según H08.
4. Actualizar índices en `specs/**` y enlace en `backlog/` (estado acorde: no fingir Approved).
...
- No implementar `src/` desde esta skill.
- No inventar alcance Out del MVP ([handbook/03](../../handbook/03-mvp-definition.md)).
